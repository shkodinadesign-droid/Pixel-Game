...
switch (dlg_step) {
    case 1:
        ...
        _line1   = "Максик, солнышко моё! Приехала наконец =)";
        _line2   = "Я так соскучилась! Как дорога?";
        break;
    case 2:
        _speaker = "Макс:";
        _sp_col  = dlg_max_col;
        _line1   = "Бабуль, всё хорошо! Я готова помогать по хозяйству =)";
        _line2   = "";
        break;
    case 3:
        _speaker = "Мэгги:";
        _sp_col  = dlg_miley_col;
        _line1   = "Вот и чудесно! Я сварю нам кофе - посидим, поговорим.";
        _line2   = "Столько всего расскажу тебе про ферму!";
        break;
    case 4:
        _speaker = "Мэгги:";
        _sp_col  = dlg_miley_col;
        _line1   = "Завтра покажу тебе огород и сарай.";
        _line2   = "А пока отдыхай, родная =)";
        _btn_lbl = "Хорошо!";
        break;
}
