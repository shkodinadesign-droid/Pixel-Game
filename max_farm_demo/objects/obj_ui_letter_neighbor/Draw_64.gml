...
// рамка кнопки (4 линии с отступом внутрь)
draw_set_color(c_white);
draw_line(btn_x1 + 1, btn_y1, btn_x2 - 1, btn_y1); // верх
draw_line(btn_x1 + 1, btn_y2, btn_x2 - 1, btn_y2); // низ
draw_line(btn_x1 + 1, btn_y1, btn_x1 + 1, btn_y2); // лево
draw_line(btn_x2 - 1, btn_y1, btn_x2 - 1, btn_y2); // право
